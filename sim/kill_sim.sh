...
PATTERNS=(
  ...
  'record_session'
  'verify_vio'
  # The FastDDS discovery server's python wrapper spawns a C++ child that
  # survives the parent and holds port 11811 (later launches fail with
  # "wasn't able to allocate the specified listening port").
